  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      if (currentProgress >= 15 && currentProgress < 40)
        setLoadingText("Kiểm tra kết nối cơ sở dữ liệu...");
      else if (currentProgress >= 40 && currentProgress < 70)
        setLoadingText("Đồng bộ hóa dữ liệu Garage & Y bạ...");
      else if (currentProgress >= 70 && currentProgress < 95)
        setLoadingText("Tải cấu hình Trợ lý A.I...");
    ...
    return (
      ...
      >
        <View style={styles.logoWrapper}>
          <Bike size={60} color={colors.systemRed} strokeWidth={1.5} />
          <Text style={[styles.brandName, { color: colors.label }]}>
            MOTOTUNE
          </Text>
        </View>
        ...
        <View style={styles.loadingBox}>
          ...
          >
            <View
              style={[
                styles.progressFill,
                { width: `${progress}%`, backgroundColor: colors.systemRed },
              ]}
            />
          </View>
          <View style={styles.statusRow}>
            ...
            <Text style={[styles.percentageText, { color: colors.label }]}>
              {progress}%
            </Text>
          </View>
        </View>
